...
const Auth: React.FC = () => {
        ...
        try {
            if (!isLogin) {
                ...
                if (!verificationStep) {
                    ...
                    const response = await fetch('http://miajobmanagementsystem-wd5a.onrender.com/api/auth/register/initiate', {
                        method: 'POST',
                        headers: {
                    ...
                    const response = await fetch('http://miajobmanagementsystem-wd5a.onrender.com/api/auth/register/verify', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
                ...
                // Login flow
                try {
                    const response = await fetch('http://miajobmanagementsystem-wd5a.onrender.com/api/auth/login', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
    ...
    const handleGoogleSuccess = async (tokenResponse: { access_token: string }) => {
        try {
            const response = await axios.post('http://miajobmanagementsystem-wd5a.onrender.com/api/auth/google', {
